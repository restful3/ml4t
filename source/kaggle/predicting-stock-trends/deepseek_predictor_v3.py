...
DEEPSEEK_TEMPERATURE = 0.6  # DeepSeek 공식 권장값 (0.5~0.7 범위, 최적 0.6)
DEEPSEEK_TOP_P = 0.95  # 안정적인 출력을 위한 nucleus sampling
...
class DeepSeekStockPredictor:
    ...
    def _create_system_prompt(self) -> str:
        """시스템 프롬프트를 생성합니다 (Phase 1: 클래스 균형 개선)."""
...
2. ⚠️ IMPORTANT: Maintain approximately 50:50 ratio between RISE and FALL predictions
3. ⚠️ Avoid being overly pessimistic - stocks can RISE as often as they FALL
4. "횡보", "중립", "持平", "판단불가" or any neutral predictions are FORBIDDEN
5. If uncertain, follow the recent trend direction
6. Write your reasoning in <think> tags
7. Write your final answer in <answer> tags

【DECISION CRITERIA】
✅ BULLISH (상승) signals (aim for ~50% of predictions):
- Golden cross (5-day MA > 20-day MA)
- Price above both moving averages
- Volume increase with price rise
- Positive momentum
- Strong upward trend in recent days

✅ BEARISH (하락) signals (aim for ~50% of predictions):
- Death cross (5-day MA < 20-day MA)
- Price below both moving averages
- Volume increase with price fall
- Negative momentum
- Strong downward trend in recent days

⚠️ BALANCE CHECK:
If you notice you're predicting mostly one direction, reconsider whether you're being too pessimistic or optimistic. The market has both ups and downs - maintain balanced judgment.
...
- Balance consideration (am I being too pessimistic/optimistic?)
- Final decision
</think>
<answer>
