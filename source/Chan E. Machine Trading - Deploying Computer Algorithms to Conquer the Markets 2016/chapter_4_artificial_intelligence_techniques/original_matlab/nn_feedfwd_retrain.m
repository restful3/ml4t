...
net.divideParam.trainRatio=1; % Use all the data in trainset1 for training
...
% Now use trained network with lowest error on second half of training set for prediction.
[~, imin]=min(errors);
net=NN{imin};
