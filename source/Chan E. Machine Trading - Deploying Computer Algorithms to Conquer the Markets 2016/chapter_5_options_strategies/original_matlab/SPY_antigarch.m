...
dailyret=backshift(1, pos).*(vxx-backshift(1, vxx))./backshift(1, vxx)-onewaytcost*abs(pos-backshift(1, pos));
...
title('Market timing VXX with anti-GARCH: out-of-sample');
xlabel('Date');
...
% Long VXX only
% CAGR=-0.005973 Sharpe=0.100784
% maxDD=-0.489997 maxDDD=932 Calmar ratio=-0.012191

% Always short VXX
% CAGR=0.674962 Sharpe=1.153400
% maxDD=-0.548804 maxDDD=217 Calmar ratio=1.229878
% So yes, model is useful!
