...
우리가 시연한 것처럼 칼만 필터를 직접 코딩하는 대신, 사용 가능한 많은 무료 오픈 소스 MATLAB 코드를 사용할 수도 있다. 그러한 패키지 중 하나는 [www.cs.ubc.ca/~murphyk/Software/Kalman/kalman.html](http://www.cs.ubc.ca/~murphyk/Software/Kalman/kalman.html)에서 찾을 수 있다. 칼만 필터는 MATLAB의 Control System Toolbox에서도 사용할 수 있다.
