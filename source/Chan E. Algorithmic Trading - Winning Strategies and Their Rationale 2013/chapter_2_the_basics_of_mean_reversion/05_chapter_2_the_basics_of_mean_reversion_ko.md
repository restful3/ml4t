...
ADF 검정은 MATLAB Econometrics 함수 *adftest*로 사용 가능하거나, 오픈 소스 MATLAB 패키지 spatial-econometrics.com의 *adf* 함수로 사용 가능하다. 아래에서는 *adf*를 사용할 것이며, 내 코드는 [http://epchan.com/book2](http://epchan.com/book2)에서 *stationarityTests.m*으로 다운로드할 수 있다. (spatial-econometrics.com의 jplv7 폴더를 컴퓨터에 다운로드한 후, 사용하기 전에 이 패키지의 모든 하위 폴더를 MATLAB 경로에 추가하는 것을 잊지 마라.)
